            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__links">
                        ...
                        <a href="#"><?php if($product) {echo $product['Category'];} else {echo "null";}?></a>
                        <span><?php if($product) {echo $product['Name'];} else {echo "null";}?></span>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="product__details__tab">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                <h6>Description</h6>
                                <p><?php if($product) {echo $product['Details'];} else {echo "null";}?></p>
                            </div>
